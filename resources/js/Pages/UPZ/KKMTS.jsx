...
const kegiatanKKMTS = kegiatanData.filter(
    item => item.kategori === "KKMTS"
);
        ...
        <AdminLayout header="KKMTS"> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS KKMTS"
                />
                ...
                <UpzKegiatan data={kegiatanKKMTS} showKategori={false} />
            </div>
