...
const originalData = [
    { bulan: "JANUARI", tanggal: "2025-01-15", pengumpulan: 4.2, pendistribusian: 2.5, muzaki: 2.0 },
    { bulan: "FEBRUARI", tanggal: "2025-02-10", pengumpulan: 2.6, pendistribusian: 4.3, muzaki: 2.0 },
    { bulan: "MARET", tanggal: "2025-03-08", pengumpulan: 3.4, pendistribusian: 1.8, muzaki: 2.8 },
    { bulan: "APRIL", tanggal: "2025-04-12", pengumpulan: 4.5, pendistribusian: 2.7, muzaki: 5.0 },
];
        ...
        <AdminLayout header="BAZNAS"> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS Baznas Kabupaten Sukabumi"
                />
                ...
                <UpzKegiatan data={kegiatanData} showKategori={true} />
