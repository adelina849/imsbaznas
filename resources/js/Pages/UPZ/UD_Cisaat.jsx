...
const kegiatanCisaat = kegiatanData.filter(
    item => item.kategori === "UPZ DESA CISAAT"
);
...
export default function BaznasDashboardSection() {
    ...
    return (
        <AdminLayout header="UPZ DESA CISAAT"> 
            <Head title="UPZ DESA CISAAT" /> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS UPZ DESA CISAAT"
                />
                ...
                <UpzKegiatan data={kegiatanCisaat} showKategori={false} />
            </div>
