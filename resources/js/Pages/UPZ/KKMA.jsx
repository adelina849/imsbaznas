...
const kegiatanKKMA = kegiatanData.filter(
    item => item.kategori === "KKMA"
);
        ...
        <AdminLayout header="KKMA"> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS KKMA"
                />
                ...
                <UpzKegiatan data={kegiatanKKMA} showKategori={false} />
            </div>
