...
const kegiatanSukaresmi = kegiatanData.filter(
    item => item.kategori === "UPZ DESA SUKARESMI"
);
...
export default function BaznasDashboardSection() {
    ...
    return (
        <AdminLayout header="UPZ DESA SUKARESMI"> 
            <Head title="UPZ DESA SUKARESMI" /> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS UPZ DESA SUKARESMI"
                />
                ...
                <UpzKegiatan data={kegiatanSukaresmi} showKategori={false} />
            </div>
