...
const kegiatanKKRA = kegiatanData.filter(
    item => item.kategori === "KKRA"
);
        ...
        <AdminLayout header="KKRA"> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS KKRA"
                />
                ...
                <UpzKegiatan data={kegiatanKKRA} showKategori={false} />
            </div>
