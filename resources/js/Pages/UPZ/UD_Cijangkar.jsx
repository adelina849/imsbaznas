...
const kegiatanCijangkar = kegiatanData.filter(
    item => item.kategori === "UPZ DESA CIJANGKAR"
);
...
export default function BaznasDashboardSection() {
    ...
    return (
        <AdminLayout header="UPZ DESA CIJANGKAR"> 
            <Head title="UPZ DESA CIJANGKAR" /> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS UPZ DESA CIJANGKAR"
                />
                ...
                <UpzKegiatan data={kegiatanCijangkar} showKategori={false} />
            </div>
