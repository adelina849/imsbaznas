...
const kegiatanGunungGuruh = kegiatanData.filter(
    item => item.kategori === "UPZ DESA GUNUNG GURUH"
);
...
export default function BaznasDashboardSection() {
    ...
    return (
        <AdminLayout header="UPZ DESA GUNUNG GURUH"> 
            <Head title="UPZ DESA GUNUNG GURUH" /> 
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                <UpzChartProfile
                    ...
                    filterJenis={filterJenis}
                    title="Grafik Pengelolaan ZIS UPZ DESA GUNUNG GURUH"
                />
                ...
                <UpzKegiatan data={kegiatanGunungGuruh} showKategori={false} />
            </div>
